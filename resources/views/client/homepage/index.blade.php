                    ...
                    <div class="feature-item fi1 col-6 col-md-3 col-sm-6 position-relative">
                        <a href="{{route("client.product.show",$value->id)}}">
                            ...
                            <div>
                                ...
                                <div class="rate">
                                    @if(round($value->comment->where("status","1")->avg("score"))==5)
                                    ...
                                    <i class="fa-solid fa-star" style="color: #c6ed02;"></i>
                                    @endif
                                    @if(round($value->comment->where("status","1")->avg("score"))==4)
                                    <i class="fa-solid fa-star" style="color: #c6ed02;"></i>
                                    <i class="fa-solid fa-star" style="color: #c6ed02;"></i>
                                    <i class="fa-solid fa-star" style="color: #c6ed02;"></i>
                                    <i class="fa-solid fa-star" style="color: #c6ed02;"></i>
                                    ...
                                    @endif
                                    @if(round($value->comment->where("status","1")->avg("score"))==3)
                                    <i class="fa-solid fa-star" style="color: #c6ed02;"></i>
                                    <i class="fa-solid fa-star" style="color: #c6ed02;"></i>
                                    <i class="fa-solid fa-star" style="color: #c6ed02;"></i>
                                    <i class="fa-regular fa-star"></i>
                                    <i class="fa-regular fa-star"></i>
                                    @endif
                                    @if(round($value->comment->where("status","1")->avg("score"))==2)
                                    <i class="fa-solid fa-star" style="color: #c6ed02;"></i>
                                    <i class="fa-solid fa-star" style="color: #c6ed02;"></i>
                                    <i class="fa-regular fa-star"></i>
                                    <i class="fa-regular fa-star"></i>
                                    <i class="fa-regular fa-star"></i>
                                    @endif
                                    @if(round($value->comment->where("status","1")->avg("score"))==1)
                                    <i class="fa-solid fa-star" style="color: #c6ed02;"></i>
                                    <i class="fa-regular fa-star"></i>
                                    <i class="fa-regular fa-star"></i>
                                    <i class="fa-regular fa-star"></i>
