    ...
    <form action="{{route("client.order.store")}}" method="POST">
        <div>
            <table border="1" style="background-color: white">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="radio" name="payment" value="0" required>
                            <label for="age1">Cash On Delivery</label><br>
                            <input type="radio" name="payment" value="1" required>
                            <label for="age2">VNPay</label><br>  
                        </td>
                    </tr>
                </tbody>
            </table>
            <div>
                    ...
                    <input type="text" name="payment" value="0" hidden>
                    <button class="btn btn-primary" type="submit">Place order with Cash On Delivery</button>
