            ...
            <nav class="promotion-bar navbar navbar-light bg-light justify-content-between">
                <div class="d-flex">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-left" aria-labelledby="dont-know-yet">
                ...
                <div class=" d-flex align-items-center">
                    ...
                    <p class="promotion-item"><a href="" >Shop Now!</a></p>
                    <p class="promotion-item"><a href="{{route("admin.admin.index")}}" >Admin Section</a></p>
                </div>
            </nav>
        </div>
    </div>
                                ...
                                <div class="variation">
                                    <ul>
                                        @foreach($categories as $key => $value)
                                            <li><a href="{{route("client.category.show",$value->id)}}">{{$value->category_name}}</a></li>
                                        @endforeach
                                    </ul>
                                </div>
                            </div>
